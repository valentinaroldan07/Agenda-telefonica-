...
public class ventana extends JFrame {
    ...
    public void Botones() {
        ...
        btnGuardar.setBounds(360, 45, 100, 40);
        panelInicio.add(btnGuardar);
        btnGuardar.repaint();
       
        JButton btnBuscar = new JButton("Buscar");
        btnBuscar.setBounds(470, 45, 100, 40);
        panelInicio.add(btnBuscar);
        btnBuscar.repaint();
        
        JButton btnActualizar = new JButton("Actualizar");
        btnActualizar.setBounds(360, 105, 100, 40);
        panelInicio.add(btnActualizar);
        btnActualizar.repaint();
        
        JButton btnEliminar = new JButton("Eliminar");
        btnEliminar.setBounds(470, 105, 100, 40);
